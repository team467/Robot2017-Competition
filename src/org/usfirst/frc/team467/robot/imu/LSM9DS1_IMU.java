...
package org.usfirst.frc.team467.robot.gyros;
 ...
 */
public class LSM9DS1_IMU extends GyroBase implements Gyro, PIDSource, LiveWindowSendable {
...
//  private static final double kDegCOffset = 31;
  ...
  public LSM9DS1_IMU(Axis yaw_axis, AHRSAlgorithm algorithm) {
    ...
    NetworkTable.setIPAddress("roborio-467-frc.local");
