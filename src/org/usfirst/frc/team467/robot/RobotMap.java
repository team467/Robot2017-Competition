...
public class RobotMap {
	...
	public static final int[] DRIVING_MOTOR_CHANNELS = { FRONT_LEFT_MOTOR_CHANNEL, BACK_LEFT_MOTOR_CHANNEL,
			BACK_RIGHT_MOTOR_CHANNEL, FRONT_RIGHT_MOTOR_CHANNEL };
	...
	public static final boolean[] IS_DRIVE_MOTOR_INVERTED = { FRONT_LEFT_DRIVE_INVERT, BACK_LEFT_DRIVE_INVERT,
			BACK_RIGHT_DRIVE_INVERT, FRONT_RIGHT_DRIVE_INVERT };
	...
	public static final int[] STEERING_MOTOR_CHANNELS = { RobotMap.FRONT_LEFT_STEERING_MOTOR_CHANNEL,
			RobotMap.BACK_LEFT_STEERING_MOTOR_CHANNEL, RobotMap.BACK_RIGHT_STEERING_MOTOR_CHANNEL,
	...
	public static final int[] STEERING_SENSOR_CHANNELS = { RobotMap.FRONT_LEFT_STEERING_SENSOR_CHANNEL,
			RobotMap.BACK_LEFT_STEERING_SENSOR_CHANNEL, RobotMap.BACK_RIGHT_STEERING_SENSOR_CHANNEL,
	...
	// PID array
	public static final PID[] PIDvalues = { new PID(-0.025, 0.0, 0.0), // Front Left PID values
	...
	public static final PID[] SpeedPIDFvalues = { new PID(0.50, 0.0036, 18.00, 2.35), // Front Left PID values
